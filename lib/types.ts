...
export const ACTIVITY_DATA = [
  { name: "সাদমান", product: "চ্যাটজিপিটি প্লাস", time: "২ মিনিট আগে" },
  { name: "নুসরাত", product: "ক্যানভা প্রো", time: "৫ মিনিট আগে" },
  { name: "তানভীর", product: "নেটফ্লিক্স প্রিমিয়াম", time: "এইমাত্র" },
  { name: "রিফাত", product: "ইউটিউব প্রিমিয়াম", time: "৮ মিনিট আগে" },
];
